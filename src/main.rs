...
//! 実装の順序は次を想定する。
//!
//! 1. ルーティング解決（REQ-0001 / REQ-0002 / REQ-0003 / REQ-0007 / REQ-0009 / REQ-0056 〜 REQ-0059）— `oci_cache::routing` として実装済み
//! 2. 上流からの取得と中継（REQ-0010 / REQ-0051）— `oci_cache::cache` として実装済み
